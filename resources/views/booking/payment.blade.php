...
<section id="Content" class="w-full max-w-[1280px] mx-auto px-[52px] mt-16 mb-[100px]">
    <div class="flex flex-col gap-16">
        ...
        <main class="flex gap-8">
            ...
            <form id="Form" enctype="multipart/form-data" action="{{route('front.payment_store')}}"method="POST" class="flex flex-col w-[724px] gap-8">
                @csrf
                        ...
                        <label class="flex flex-col gap-4">
                            <div class="group flex items-center rounded-xl p-4 gap-2 bg-[#FBFBFB] overflow-hidden">
                                <div class="flex items-center w-full gap-2 text-aktiv-grey group-has-[:valid]:text-aktiv-black transition-all duration-300">
                                    ...
                                    <p id="Upload-btn" class="font-medium text-lg leading-[27px] group-has-[:valid]:font-semibold">Upload bukti pembayaran</p>   
                                </div>
...
<script src="{{asset('js/filament/upload-file.js')}}"></script>
<x-footer />
@endpush
